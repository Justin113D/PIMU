...
static void AES_EncryptInit(AES_CTX *ctx, const unsigned char *key) {
...
// Encrypt data
static void AES_Encrypt(AES_CTX *ctx, const unsigned char *in_data, unsigned int in_size, unsigned char *out_data) {
...
// Decrypt data
static void AES_Decrypt(AES_CTX *ctx, const unsigned char *in_data, unsigned int in_size, unsigned char *out_data) {
	unsigned int s0, s1, s2, s3, t0, t1, t2, t3, offset;
